...
/***/ "./source/js/modules/canvasScene.js":
/*!******************************************!*\
  !*** ./source/js/modules/canvasScene.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities */ "./source/js/modules/utilities.js");
/* harmony import */ var _canvasScene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canvasScene */ "./source/js/modules/canvasScene.js");
...
class crocodileCanvas extends _canvasScene__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(options) {
  ...
  initFlamingoAnimations() {
    ...
    this.animations.push(
        new _animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
          ...
          easing: _utilities__WEBPACK_IMPORTED_MODULE_1__["default"].easeOutCubic,
          delay: 100,
          duration: 800,
        })
    );
    ...
    this.animations.push(
        new _animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
          ...
          easing: _utilities__WEBPACK_IMPORTED_MODULE_1__["default"].easeInCubic,
          delay: 900,
          duration: 600,
        })
    );
  ...
  initDropAnimations() {
    this.animationsDrop.push(new _animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: (progress) => {
...
class walrusScene extends _canvasScene__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(options) {
    const canvas = options.canvas;
  ...
  initIceAndWalrusAnimations() {
    this.animations.push(
        new _animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
          func: (progress) => {
            ...
            this.objectsScene.walrus.transforms.translateY =
              30 * progressReversed;
            this.objectsScene.walrus.transforms.rotate = -30 * Math.sin(progressReversed * 2);
          },
          delay: 500,
          duration: 2000,
    ...
    this.animations.push(
        new _animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
          func: (progress) => {
            this.objectsScene.walrus.opacity = progress;
  ...
  startAnimation() {
    ...
    this.initIceAndWalrusAnimations();
